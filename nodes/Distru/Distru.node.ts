...
export class Distru implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
				...
				options: [
					{
						...
						routing: {
							request: {
								...
								url: '/companies',
								qs: {
									inserted_datetime: '={{$parameter["insertedDatetime"]}}',
									updated_datetime: '={{$parameter["updatedDatetime"]}}',
								},
							},
						},
					},
						...
						routing: {
							request: {
								...
								body: {
									...
									custom_data: '={{$parameter["custom_data"]}}',
								},
							},
						},
					},
			...
			{ displayName: 'Inserted After', name: 'insertedDatetime', type: 'dateTime', default: '', displayOptions: { show: { resource: ['company'], operation: ['getAll'] } } },
			{ displayName: 'Updated After', name: 'updatedDatetime', type: 'dateTime', default: '', displayOptions: { show: { resource: ['company'], operation: ['getAll'] } } },
			...
			{ displayName: 'Due Datetime', name: 'dueDatetime', type: 'dateTime', default: '', displayOptions: { show: { resource: ['order'], operation: ['create'] } } },
			{ displayName: 'Delivery Datetime', name: 'deliveryDatetime', type: 'dateTime', default: '', displayOptions: { show: { resource: ['order'], operation: ['create'] } } },
			...
			{ displayName: 'Inventory Tracking Method', name: 'inventory_tracking_method', type: 'options', options: [
				{ name: 'PACKAGE', value: 'PACKAGE' },
				{ name: 'PRODUCT', value: 'PRODUCT' },
				{ name: 'BATCH', value: 'BATCH' },
			], default: 'PACKAGE', displayOptions: { show: { resource: ['product'], operation: ['upsert'] } } },
			...
			{ displayName: 'Menu Visibility', name: 'menu_visibility', type: 'options', options: [
			...
			], default: 'INCLUDE_IN_ALL', displayOptions: { show: { resource: ['product'], operation: ['upsert'] } } },
			{ displayName: 'Menus (if INCLUDE_IN_SELECT)', name: 'menus', type: 'string', typeOptions: { multipleValues: true }, default: [], displayOptions: { show: { resource: ['product'], operation: ['upsert'], menu_visibility: ['INCLUDE_IN_SELECT'] } } },
			...
			{ displayName: 'Total Cannabinoid Unit', name: 'total_cannabinoid_unit', type: 'options', options: [
				{ name: 'MG', value: 'MG' },
				{ name: 'PERCENT', value: 'PERCENT' },
			], default: 'PERCENT', displayOptions: { show: { resource: ['product'], operation: ['upsert'] } } },
			...
			{ displayName: 'Unit Net Weight & Serving Size Unit Type ID', name: 'unit_net_weight_and_serving_size_unit_type_id', type: 'string', default: '', displayOptions: { show: { resource: ['product'], operation: ['upsert'] } } },
			...
			{ displayName: 'Tags', name: 'tags', type: 'string', typeOptions: { multipleValues: true }, default: [], displayOptions: { show: { resource: ['product'], operation: ['upsert'] } } },
			{ displayName: 'Inserted After', name: 'insertedDatetime', type: 'dateTime', default: '', displayOptions: { show: { resource: ['product'], operation: ['getAll'] } } },
			{ displayName: 'Updated After', name: 'updatedDatetime', type: 'dateTime', default: '', displayOptions: { show: { resource: ['product'], operation: ['getAll'] } } },
		],
	};
}
